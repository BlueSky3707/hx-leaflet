<template>
  <div id="maptools">
<el-row>
  <el-button v-on:click="startPoint" type="primary" icon="el-icon-edit" circle ></el-button>
  <el-button v-on:click="startDrawPolygon" type="success" icon="el-icon-check" circle></el-button>
  <el-button type="info" icon="el-icon-message" circle></el-button>
  <el-button v-on:click="clearGrahics" type="danger" icon="el-icon-delete" circle></el-button>
</el-row>
  </div>
</template>
